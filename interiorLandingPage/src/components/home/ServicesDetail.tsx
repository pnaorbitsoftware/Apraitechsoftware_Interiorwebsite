          ...
          {services.map((service, i) => (
            ...
            >
              <Link
                ...
                className="block p-8 rounded-lg border border-gray-200 hover:border-amber-500 hover:shadow-lg transition-all group"
              >
                ...
                <span className="inline-flex items-center gap-2 mt-4 text-amber-600 font-semibold text-sm group-hover:gap-3 transition-all">
                  Explore
